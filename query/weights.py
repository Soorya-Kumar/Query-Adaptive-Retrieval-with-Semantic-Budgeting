...
_WEIGHT_TABLE: dict[tuple[str, str], QueryWeights] = {
    ...
    ("shallow", "any"):        QueryWeights(0.60, 0.25, 0.15, 0.0),
    ("shallow", "recent"):     QueryWeights(0.55, 0.25, 0.20, 0.3),
    ("shallow", "historical"): QueryWeights(0.55, 0.25, 0.20, 0.5),
    ("shallow", "timeless"):   QueryWeights(0.60, 0.25, 0.15, 0.0),

    # medium queries — balanced
    ("medium", "any"):         QueryWeights(0.50, 0.30, 0.20, 0.0),
    ("medium", "recent"):      QueryWeights(0.45, 0.40, 0.15, 0.5),
    ("medium", "historical"):  QueryWeights(0.45, 0.40, 0.15, 0.8),
    ("medium", "timeless"):    QueryWeights(0.45, 0.40, 0.15, 0.0),

    # deep queries — fine grained, high specificity
    ("deep", "any"):           QueryWeights(0.40, 0.30, 0.40, 0.0),
    ("deep", "recent"):        QueryWeights(0.40, 0.30, 0.40, 0.7),
    ("deep", "historical"):    QueryWeights(0.40, 0.30, 0.40, 1.0),
    ("deep", "timeless"):      QueryWeights(0.40, 0.30, 0.40, 0.0),
}

_DEFAULT = QueryWeights(0.55, 0.30, 0.15, 0.0)
